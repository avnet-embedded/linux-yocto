...
const struct v4l2_format_info *v4l2_format_info(u32 format)
{
	static const struct v4l2_format_info formats[] = {
		...
		{ .format = V4L2_PIX_FMT_YUV444P, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 3, .bpp = { 1, 1, 1, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 1, .vdiv = 1 },
		...
		{ .format = V4L2_PIX_FMT_T5M8, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 1, .bpp = { 1, 0, 0, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 32, 0, 0, 0 }, .block_h = { 4, 0, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T5MA, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 1, .bpp = { 5, 0, 0, 0 }, .bpp_div = { 4, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 32, 0, 0, 0 }, .block_h = { 4, 0, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T5MC, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 1, .bpp = { 3, 0, 0, 0 }, .bpp_div = { 2, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 32, 0, 0, 0 }, .block_h = { 4, 0, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T6M8, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 1, .bpp = { 1, 0, 0, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 64, 0, 0, 0 }, .block_h = { 4, 0, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T6MA, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 1, .bpp = { 5, 0, 0, 0 }, .bpp_div = { 5, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 64, 0, 0, 0 }, .block_h = { 4, 0, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T6MC, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 1, .bpp = { 3, 0, 0, 0 }, .bpp_div = { 2, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 64, 0, 0, 0 }, .block_h = { 4, 0, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T508, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 1, 1, 0, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 2, .vdiv = 2,
		  .block_w = { 32, 32, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T50A, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 5, 5, 0, 0 }, .bpp_div = { 4, 4, 1, 1 }, .hdiv = 2, .vdiv = 2,
		  .block_w = { 32, 32, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T50C, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 3, 3, 0, 0 }, .bpp_div = { 2, 2, 1, 1 }, .hdiv = 2, .vdiv = 2,
		  .block_w = { 32, 32, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T608, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 1, 1, 0, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 2, .vdiv = 2,
		  .block_w = { 64, 64, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T60A, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 5, 5, 0, 0 }, .bpp_div = { 5, 5, 1, 1 }, .hdiv = 2, .vdiv = 2,
		  .block_w = { 64, 64, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T60C, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 3, 3, 0, 0 }, .bpp_div = { 2, 2, 1, 1 }, .hdiv = 2, .vdiv = 2,
		  .block_w = { 64, 64, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T528, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 1, 1, 0, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 2, .vdiv = 1,
		  .block_w = { 32, 32, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T52A, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 5, 5, 0, 0 }, .bpp_div = { 4, 4, 1, 1 }, .hdiv = 2, .vdiv = 1,
		  .block_w = { 32, 32, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T52C, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 3, 3, 0, 0 }, .bpp_div = { 2, 2, 1, 1 }, .hdiv = 2, .vdiv = 1,
		  .block_w = { 32, 32, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T628, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 1, 1, 0, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 2, .vdiv = 1,
		  .block_w = { 64, 64, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T62A, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 5, 5, 0, 0 }, .bpp_div = { 4, 4, 1, 1 }, .hdiv = 2, .vdiv = 1,
		  .block_w = { 64, 64, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T62C, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 1, .comp_planes = 2, .bpp = { 3, 3, 0, 0 }, .bpp_div = { 2, 2, 1, 1 }, .hdiv = 2, .vdiv = 1,
		  .block_w = { 64, 64, 0, 0 }, .block_h = { 4, 4, 0, 0 }},
		{ .format = V4L2_PIX_FMT_T548, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 1, 1, 1, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 32, 32, 32, 0 }, .block_h = { 4, 4, 4, 0 }},
		{ .format = V4L2_PIX_FMT_T54A, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 5, 5, 5, 0 }, .bpp_div = { 4, 4, 4, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 32, 32, 32, 0 }, .block_h = { 4, 4, 4, 0 }},
		{ .format = V4L2_PIX_FMT_T54C, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 3, 3, 3, 0 }, .bpp_div = { 2, 2, 2, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 32, 32, 32, 0 }, .block_h = { 4, 4, 4, 0 }},
		{ .format = V4L2_PIX_FMT_T648, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 1, 1, 1, 0 }, .bpp_div = { 1, 1, 1, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 64, 64, 64, 0 }, .block_h = { 4, 4, 4, 0 }},
		{ .format = V4L2_PIX_FMT_T64A, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 5, 5, 5, 0 }, .bpp_div = { 4, 4, 4, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 64, 64, 64, 0 }, .block_h = { 4, 4, 4, 0 }},
		{ .format = V4L2_PIX_FMT_T64C, .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 3, 3, 3, 0 }, .bpp_div = { 2, 2, 2, 1 }, .hdiv = 1, .vdiv = 1,
		  .block_w = { 64, 64, 64, 0 }, .block_h = { 4, 4, 4, 0 }},
		...
		{ .format = V4L2_PIX_FMT_X423,    .pixel_enc = V4L2_PIXEL_ENC_YUV, .mem_planes = 3, .comp_planes = 3, .bpp = { 3, 3, 3, 0 }, .bpp_div = { 2, 2, 2, 1 }, .hdiv = 1, .vdiv = 1 },
