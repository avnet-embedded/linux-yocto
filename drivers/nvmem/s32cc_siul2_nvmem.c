...
/* SIUL2_0_MIDR1 masks */
#define SIUL2_0_MIDR1_MINOR_MASK	(0xF << 0)
#define SIUL2_0_MIDR1_MAJOR_SHIFT	(4)
#define SIUL2_0_MIDR1_MAJOR_MASK	(0xF << SIUL2_0_MIDR1_MAJOR_SHIFT)
#define SIUL2_0_MIDR1_PART_NO_SHIFT	(16)
#define SIUL2_0_MIDR1_PART_NO_MASK	GENMASK(25, 16)

/* SIUL2_1_MIDR2 masks */
#define SIUL2_1_MIDR2_SERDES_MASK	BIT(15)
				    ...
				    void *val, size_t bytes)
{
	...
	switch (offset) {
	case SOC_MAJOR_OFFSET:
		midr1 = ioread32(priv->siul2 + SIUL2_MIDR1_OFF);
		major = (midr1 & SIUL2_0_MIDR1_MAJOR_MASK) >> SIUL2_0_MIDR1_MAJOR_SHIFT;
	...
	case SOC_MINOR_OFFSET:
		midr1 = ioread32(priv->siul2 + SIUL2_MIDR1_OFF);
		minor = midr1 & SIUL2_0_MIDR1_MINOR_MASK;
	...
	case PCIE_DEV_ID_OFFSET:
		midr1 = ioread32(priv->siul2 + SIUL2_MIDR1_OFF);
		part_no = (midr1 & SIUL2_0_MIDR1_PART_NO_MASK) >> SIUL2_0_MIDR1_PART_NO_SHIFT;
				    ...
				    void *val, size_t bytes)
{
	...
	serdes = !!(midr2 & SIUL2_1_MIDR2_SERDES_MASK);
	*(u32 *)val = serdes;
