			       ...
			       void *val, size_t bytes)
{
	...
	switch (offset) {
	case S32G_GPR_PFE_COH_EN_OFFSET:
		...
		break;
	case S32G_GPR_PFE_GENCTRL3_OFFSET:
				 ...
				 void *val, size_t bytes)
{
	...
	switch (offset) {
	case S32CC_GPR_DDR_PMU_IRQ_OFFSET:
	...
	case S32CC_GPR_GMAC0_PHY_INTF_SEL_OFFSET:
				...
				size_t bytes)
{
	...
	switch (offset) {
	case S32G_GPR_PFE_EMACS_INTF_SEL_OFFSET:
	...
	case S32G_GPR_PFE_PWR_CTRL_OFFSET:
	...
	case S32G_GPR_PFE_EMACS_GENCTRL1_OFFSET:
				  ...
				  void *val, size_t bytes)
{
	...
	switch (offset) {
	case S32R45_GPR_GMAC1_PHY_INTF_SEL_OFFSET:
