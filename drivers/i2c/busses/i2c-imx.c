...
/* S32CC clock divider, register value pairs */
static struct imx_i2c_clk_pair s32cc_i2c_clk_div[] = {
...
static struct imx_i2c_hwdata s32cc_i2c_hwdata = {
	.devtype		= S32CC_I2C,
	.regshift		= S32CC_I2C_REGSHIFT,
	.clk_div		= s32cc_i2c_clk_div,
	.ndivs			= ARRAY_SIZE(s32cc_i2c_clk_div),
	.i2sr_clr_opcode	= I2SR_CLR_OPCODE_W1C,
	.i2cr_ien_opcode	= I2CR_IEN_OPCODE_0,
};
...
static const struct of_device_id i2c_imx_dt_ids[] = {
	...
	{ .compatible = "nxp,s32cc-i2c", .data = &s32cc_i2c_hwdata, },
	{ /* sentinel */ }
};
