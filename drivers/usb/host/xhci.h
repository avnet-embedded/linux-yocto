...
#define XHCI_SUSPEND_RESUME_CLKS	BIT_ULL(46)
#define XHCI_RESET_TO_DEFAULT	BIT_ULL(47)
#define XHCI_TRB_OVERFETCH	BIT_ULL(48)
#define XHCI_ZHAOXIN_HOST	BIT_ULL(49)
#define XHCI_WRITE_64_HI_LO	BIT_ULL(50)
#define XHCI_CDNS_SCTX_QUIRK	BIT_ULL(51)
#define XHCI_LIMIT_ENDPOINT_INTERVAL_9 BIT_ULL(52)
